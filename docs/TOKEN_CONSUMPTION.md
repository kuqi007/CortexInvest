...
> **双平台合计**: 2,228.10M+ tokens (22.28 亿)
> 
> 数据来源：
> - 智谱 AI 开放平台历史累计用量
> - MiniMax 开放平台 2026-04 月度账单
> 
> 说明：本项目为重度 LLM 用户，月均消耗超 15 亿 tokens
...
### Current Usage（基于双平台真实数据）

| Metric | Value | 来源 |
|--------|-------|------|
| **双平台累计消耗** | **2,228.10M tokens** | 智谱 + MiniMax |
| **MiniMax 月均** | **1,522.49M tokens** | 2026-04 账单 |
| **智谱月均** | ~30M tokens | 历史累计平均 |
| **双平台月均** | **~1,550M tokens** | **15.5 亿/月** |
| **日均消耗** | **~51.7M tokens** | MiniMax 4月数据 |
| **峰值日均** | ~74M+ tokens | 双平台叠加 |
...
**双平台累计**: 2,228.10M+ tokens (22.28 亿)
