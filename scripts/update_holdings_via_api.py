...
def main():
    ...
    holdings = [
        ...
        ("600673", "东阳光", "holding", 28.654, 1800, True),
        ("002080", "中材科技", "holding", 48.063, 2200, True),
        # 同花顺港股
        ("HK01810", "小米集团", "holding", 51.665, 200, False),
        # 同花顺ETF
        ...
        ("HK09888", "FIT HON", "holding", 8.22, 2000, False),
        ("HK02570", "英诺赛科", "holding", 63.872, 600, False),
        ("HK00700", "腾讯控股", "holding", 627.101, 100, False),
        ("HK09988", "阿里巴巴", "holding", 169.942, 400, False),
        ...
        ("HK07709", "南方两倍做多恒生科技", "holding", 21.523, 1500, True),
